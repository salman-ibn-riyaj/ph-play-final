      ...
      <div className="flex gap-3">
        ...
        <div>
          <div>
            ...
            <p className="text-2xl font-bold">Developed by: <span className="text-purple-500">{`${expectedAppData.companyName}`}</span></p>
            ...
            <div className="flex gap-4 my-3">
              <div className="flex flex-col items-center">
                ...
                <h3 className="font-bold text-2xl">{expectedAppData.downloads}</h3>
              </div>
              <div className="flex flex-col items-center">
                <span>
                ...
                <h3 className="font-bold text-2xl">{expectedAppData.ratingAvg}</h3>
              </div>
              <div className="flex flex-col items-center">
                <span>
                ...
                <h3 className="font-bold text-2xl">{expectedAppData.reviews}</h3>
              </div>
            </div>
